...
class _StretchyHeaderBaseState extends State<StretchyHeaderBase> {
  ...
  double _offset = 0;
  double _headerSize = 0;
  double _highlightHeaderSize = 0;
  bool canTriggerRefresh = true;

  void _onLayoutDone(dynamic _) {
    final renderBox =
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.headerData.highlightHeaderAlignment ==
      ...
      highlightPosition = (_offset >= 0.0 ? -_offset : 0.0).toInt();
      ...
      highlightPosition =
          (_headerSize - _offset - _highlightHeaderSize).toInt();
    }
    return Container(
        ...
        children: <Widget>[
          ...
          if (widget.headerData.highlightHeader != null)
            Positioned(
              ...
              top: highlightPosition.toDouble(),
...
class HeaderClipper extends CustomClipper<Rect> {
  ...
  @override
  getClip(Size size) => Rect.fromLTRB(0, 0, size.width, height);
