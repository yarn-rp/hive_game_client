...
const double _kNavBarShowLargeTitleThreshold = 10;

const double _kNavBarEdgePadding = 16;
                ...
                child: OverflowBox(
                  ...
                  child: Padding(
                    padding: const EdgeInsetsDirectional.only(
                      ...
                      bottom: 8, // Bottom has a different padding.
                    ),
                    child: SafeArea(
                      top: false,
                      bottom: false,
...
class _TransitionableNavigationBar extends StatelessWidget {
  ...
  RenderBox get renderBox {
    final box = componentsKeys.navBarBoxKey.currentContext!
...
class _NavigationBarComponentsTransition {
  ...
  RelativeRectTween slideFromLeadingEdge({
    ...
    if (forwardDirection < 0) {
      ...
      // the center lefts.
      toRect = toRect.translate(-fromBox.size.width + toBox.size.width, 0);
    }
  ...
  Widget? get topBackLabel {
    ...
    final topBackLabelOpacity = topComponents
  ...
  Widget? get topLargeTitle {
    ...
    final to = positionInTransitionBox(topComponents.largeTitleKey,
        from: topNavBarBox);
